# CodedPixels — Documentation Index

**Coordinator:** Dr. Nathan Cole · **Docs:** Dr. Lena Moreau

## Overview

| Document | Description |
|----------|-------------|
| [What we're building](overview/what-we-are-building.md) | Plain-English guide (Mia Thompson) |
| [Brand guide](brand/brand-guide.md) | Colours, logo, voice, copy library |

## Specifications

| Document | Description |
|----------|-------------|
| [Project plan](specs/codedpixels-project-plan.md) | Master spec — product, pricing, Q1–Q64 |
...
| Document | Description |
|----------|-------------|
| [Development workflow rules](process/development-workflow-rules.md) | Contributor/agent workflow (v1.5) |
| [Using spec files](process/using-specs.md) | How and why to use specs before coding |
| [Resume command](process/resume-command.md) | **`/codedpixels resume`** — pick up in any chat |

## Root files (outside `docs/`)

| File | Description |
|------|-------------|
| [`../.cursor/AGENTS.md`](../.cursor/AGENTS.md) | Agent quick start |
| [`../.cursor/experts.md`](../.cursor/experts.md) | Expert roster |
