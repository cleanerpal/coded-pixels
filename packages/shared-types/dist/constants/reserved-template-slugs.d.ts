 ...
 */
export declare const RESERVED_TEMPLATE_SLUGS: readonly ["sparkle-clean", "trade-pro", "serenity-spa", "glow-studio", "apex-legal", "corner-shop", "the-local", "learn-hub", "business-core", "startup-launch", "wellness-clinic", "clear-accounting", "focus-photography", "fit-hub"];
