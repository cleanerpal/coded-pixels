...
import {
  CtaBannerEditorPanel,
  ContactFormEditorPanel,
  FeaturesGridEditorPanel,
  FooterEditorPanel,
  HeroEditorPanel,
  ImageGalleryEditorPanel,
  TestimonialsEditorPanel,
  TextBlockEditorPanel,
} from './editor-panels';
import {
  ...
  ctaBannerSchema,
  featuresGridDefaultProps,
  featuresGridSchema,
  footerDefaultProps,
  footerSchema,
  heroDefaultProps,
  heroSchema,
  imageGalleryDefaultProps,
  imageGallerySchema,
  testimonialsDefaultProps,
  testimonialsSchema,
...
export function getComponentDefinition(type: string) {
  return componentRegistry[type as keyof ComponentRegistry];
}

export function isRegisteredComponentType(type: string): type is keyof ComponentRegistry {
